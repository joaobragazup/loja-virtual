...
public abstract class NossaLojaVirtualApplicationTest {
    ...
    public MockHttpServletRequestBuilder POST(String uri, Object payload, Object...uriVars) throws JsonProcessingException {
        String json = mapper.writeValueAsString(payload);
