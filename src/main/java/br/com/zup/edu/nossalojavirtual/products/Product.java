...
class Product {
    ...
    public Product(@NotNull PreProduct preProduct,
        ...
        greaterOrEqualToZero(preProduct.getStockQuantity(),"stockQuantity must not be negative");
        greaterThanZero(preProduct.getPrice(),"price must not be negative or zero");
